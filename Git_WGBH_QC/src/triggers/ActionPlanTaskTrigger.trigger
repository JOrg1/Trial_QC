trigger ActionPlanTaskTrigger on Task ( after update, after delete , before delete) {
    ...
    /**=========To test value Ref:Jira Tkt 77 May 25,2012====**/
    System.debug('##in If trigger.isUpdate && trigger.isAfter');
    /**======================================================**/
        ...
        for( Task t : Trigger.new ) {
            ...
            if (t.TaskTemplateId__c != null){
                ...
                /**=========To test value Ref:Jira Tkt 77 May 25,2012====**/
                System.debug('##inProgressTasks==> ' + inProgressTasks);
                System.debug('##closedTasks==> ' + closedTasks);
                /**===========================================**/
            }
       }
        ...
        if( !closedTasks.isEmpty() ) {
            ...
            /**=========To test value Ref:Jira Tkt 77 May 25,2012====**/
            System.debug('##in If of !closedTasks.isEmpty()');
           /**===========================================**/
        ...
        //update status to in progress for AP Tasks
         if( !inProgressTasks.isEmpty() ) {
           ...
           /**=========To test value Ref:Jira Tkt 77 May 25,2012====**/
            System.debug('##in If of !inProgressTasks.isEmpty()');
           /**===========================================**/
